...
const STATUS_META: Record<string, { label: string; color: string; bg: string }> = {
  ...
  published: { label: "Đã đăng", color: "#7c3aed", bg: "rgba(34,197,94,0.12)" },
};
    ...
    <div className="geo-optimizer">
      ...
      {stats && (
        <div className="spin-stats">
          ...
          <div className="spin-stat"><span className="spin-stat-label">Đã đăng</span><span className="spin-stat-value" style={{ color: "#7c3aed" }}>{stats.published}</span></div>
