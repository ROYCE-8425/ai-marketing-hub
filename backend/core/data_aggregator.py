...
try:
    from core.google_analytics import GoogleAnalytics
    ...
    try:
        ...
        # Running as top-level script — silence imports, gracefully degrade at runtime
        GoogleAnalytics = None  # type: ignore
        GoogleSearchConsole = None  # type: ignore
        DataForSEO = None  # type: ignore
